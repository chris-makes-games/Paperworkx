...
public class QuizManager : MonoBehaviour
{
  ...
  void PopulateAllThemes()
  {
    ...
    allThemePools[0].Add(new QuestionData { question = "Of which country do you hold citizenship?\nA. Polar Republic\nB. Terrarian Union", answer = "B" });
    allThemePools[0].Add(new QuestionData { question = "Is your current net worth below 10,000 in credits per solar rotation?\nA. Yes \nB. No", answer = "B" });
    allThemePools[0].Add(new QuestionData { question = "Have you committed any crimes against the government?\nA. Yes \nB. no", answer = "B" });
    allThemePools[0].Add(new QuestionData { question = "Have you lost a place of residence in a climate change related disaster?\nA.Yes\nB. No", answer = "B" });
    ...
    allThemePools[1].Add(new QuestionData { question = "Did the current President vote in support of the Immigration Crisis act of 2070?\nA.Yes?\nB. No", answer = "A" });


    // Theme 3 15 questions
    allThemePools[2].Add(new QuestionData { question = "Do you consent to a background check, which is mandatory to receive a visa for immigration to Mars?\nA.Yes\n B. No", answer = "A" });
    allThemePools[2].Add(new QuestionData { question = "Do you consent to random monitoring of your digital footprint and online habits?\n A.Yes \n B.No", answer = "A" });
    allThemePools[2].Add(new QuestionData { question = "Do you consent to your answers and likeness being used to train Artificial Intelligence models?\n A.Yes \n B.No", answer = "A" });
    allThemePools[2].Add(new QuestionData { question = "Do you recognize that receiving a visa means you forfeit your right to your private medical records?\n A.Yes \n B.No", answer = "A" });
    allThemePools[2].Add(new QuestionData { question = "Do you consent to the permanent collection and storage of your biometric data (genetic markers, retinal scan, etc.)?\nA.Yes\nB. No", answer = "A" });
  }
  ...
  public void CheckAnswer()
  {
    if (!isAnswerSaved)
    {
      feedbackText.text = "Answer needs to be saved before submitting!";
